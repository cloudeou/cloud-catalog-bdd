export const envConfig = {
  envName: "it02",
  baseUrl:
    "https://flcncapp-itn02.tsl.telus.com/OSSJ/OrderManagement/NcOssjOrderManagementWebService",
  ...
  cosldap: {
    baseUrl: "https://apigw-st.tsl.telus.com/enterprise/serviceInventory/v1",
